...
public class FilterExceptionHandler {
    ...
    public void sendErrorMessage(HttpServletResponse response, ErrorType errorType, Throwable cause)
            throws IOException {
        ApiResponse<Object> failure = ApiResponse.error(errorType, null, cause.getMessage());
